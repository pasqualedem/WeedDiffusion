...
def main():
    ...
    #     monitor='val_loss', filename=cfg['experiment']['id'] + '_{epoch:02d}_{val_loss:.4f}', mode='min', save_last=True, save_top_k=1)
    ...
    # visualizer_callback = VisualizerCallback(get_visualizers(cfg), cfg['train']['vis_train_every_x_epochs'], val_every_x_epochs=None)
    # postprocessor_callback = PostprocessorrCallback(get_postprocessors(cfg), cfg['train']['postprocess_train_every_x_epochs'], val_every_x_epochs=None)
